...
<body id="page-top">
    ...
    if (isset($_POST['edit_staff'])) {
        ...
        if (mysqli_query($con, $sql1)) {
            echo "<script>alert('Doctor Details Updated');
                window.location.assign('edit_doc.php?id=$re_id');
                </script>";
        } else {
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="text-align: left; color: #5da2f3;" class="m-0 font-weight-bold"><i class="fas fa-edit"></i> Edit Doctor</h6>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            ?>
                                    <form action="edit_doc.php" method="post" enctype="multipart/form-data">
